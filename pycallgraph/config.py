...
class Config(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.trace_filter = GlobbingFilter(exclude=["pycallgraph.*"], include=["*"],)
    ...
    def convert_filter_args(self):
        ...
        self.trace_filter = GlobbingFilter(include=self.include, exclude=self.exclude,)
    ...
    def create_parser(self):
        ...
        """
        usage = (
            "pycallgraph [options] OUTPUT_TYPE [output_options] -- "
            "SCRIPT.py [ARG ...]"
        )

        self.parser = argparse.ArgumentParser(
            description="Python Call Graph profiles a Python script and "
            "generates a call graph visualization.",
            usage=usage,
        )
    ...
    def create_parent_parser(self):
        ...
        parent_parser.add_argument(
            "command", metavar="SCRIPT", help="The Python script file to profile",
        )
        parent_parser.add_argument(
            "command_args", metavar="ARG", nargs="*", help="Python script arguments."
        )
    ...
    def add_ungrouped_arguments(self):
        ...
        self.parser.add_argument(
            ...
            action="store_false",
            default=self.groups,
            help="Do not group functions by module",
        )
    ...
    def add_filter_arguments(self):
        ...
        group.add_argument(
            "--include-pycallgraph",
            default=self.include_pycallgraph,
            action="store_true",
